...
*/      
 ...
 //             if(ping_result && in_catch_up_mode){
...
void checkFileLimit() {
  if (file_num < max_file_number)      // increment file number if not over limit
    {                                      
     ...
     else if( (file_num == max_file_number && last_file == 0)             // delete files if over limit and all files have been sent
